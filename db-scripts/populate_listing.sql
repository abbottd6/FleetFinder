...
VALUES 
	...
	(SELECT style_id FROM play_style WHERE play_style = 'Casual'), (SELECT legality_id FROM legality WHERE legality = 'Undefined'), (SELECT group_status_id FROM group_status WHERE group_status = 'Current/Live'),
...
VALUES 
	...
	(SELECT style_id FROM play_style WHERE play_style = 'Casual'), (SELECT legality_id FROM legality WHERE legality = 'Lawful'), (SELECT group_status_id FROM group_status WHERE group_status = 'Current/Live'),
