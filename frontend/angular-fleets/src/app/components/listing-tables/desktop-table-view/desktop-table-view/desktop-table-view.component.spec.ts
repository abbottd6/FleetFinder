...
describe('DesktopTableViewComponent', () => {
  ...
  beforeEach(async () => {
    const listingInteractSpy = jasmine.createSpyObj('ListingViewInteractionsService',
      ['setSelectedListing', 'userIsListingOwner'], { selectedListing$: of(null), bookmarkedIds$: of(new Set()) });
    ...
    const uiPrefsSpy = jasmine.createSpyObj('UiPrefsService',
      ['loadUiPrefs', 'saveRowClick'], { uiPrefs: { clickedRowIds: new Set(), hideHiddenListingHint: false, hideBookmarkedListingHint: false } });
    ...
    await TestBed.configureTestingModule({
      imports: [DesktopTableViewComponent],
      providers: [
