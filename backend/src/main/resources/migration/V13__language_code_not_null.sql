UPDATE group_listing SET language_code = 'EN' WHERE language_code IS NULL;
UPDATE listing_archive SET language_code = 'EN' WHERE language_code IS NULL;
UPDATE listing_template SET language_code = 'EN' WHERE language_code IS NULL;
