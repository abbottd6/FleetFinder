...
INSERT INTO crew_subgroup_template (template_id, parent_subgroup_id, subgroup_label)
VALUES
    #IDRIS
    (@idris, NULL, 'Idris'),
    (@idris, NULL, 'Bridge'),
    (@idris, NULL, 'Gunnery'),
    (@idris, NULL, 'Engineering'),
    (@idris, NULL, 'Medical'),
    (@idris, NULL, 'Fighter Bay'),
    (@idris, NULL, 'Marine Detachment'),
    #POLARIS
    (@polaris, NULL, 'Polaris'),
    (@polaris, NULL, 'Bridge'),
    (@polaris, NULL, 'Gunnery'),
    (@polaris, NULL, 'Engineering'),
    (@polaris, NULL, 'Weapons Station'),
    (@polaris, NULL, 'Medical'),
    (@polaris, NULL, 'Fighter Bay'),
    #Generic Capital
    (@gencap, NULL, 'Generic Capital'),
    (@gencap, NULL, 'Bridge'),
    (@gencap, NULL, 'Gunnery'),
    (@gencap, NULL, 'Engineering'),
    (@gencap, NULL, 'Medical'),
    (@gencap, NULL, 'Utility'),
    (@gencap, NULL, 'Fighter Bay'),
    (@gencap, NULL, 'Marine Detachment'),
    #HAMMERHEAD
    (@hh, NULL, 'Hammerhead'),
    (@hh, NULL, 'Bridge'),
    (@hh, NULL, 'Gunnery'),
    ...
    (@a2, NULL, 'Bridge'),
    (@a2, NULL, 'Engineering'),
    (@a2, NULL, 'Ground Assault'),
    #Starfarer/Gemini
    (@gemini, NULL, 'Starfarer/Gemini'),
    (@gemini, NULL, 'Bridge'),
    (@gemini, NULL, 'Gunnery'),
    (@gemini, NULL, 'Fuel Operations'),
    (@gemini, NULL, 'Engineering'),
    #Starlancer TAC
    (@tac, NULL, 'Starlancer TAC'),
    (@tac, NULL, 'Bridge'),
    (@tac, NULL, 'Gunnery'),
    (@tac, NULL, 'Medical'),
    (@tac, NULL, 'Engineering'),
    #890 Jump
    (@890, NULL, '890 Jump'),
    (@890, NULL, 'Bridge'),
    (@890, NULL, 'Gunnery'),
    (@890, NULL, 'Medical'),
    (@890, NULL, 'Engineering'),
    (@890, NULL, 'Security'),
    #Retaliator
    (@ret, NULL, 'Retaliator'),
    (@ret, NULL, 'Bridge'),
    (@ret, NULL, 'Gunnery'),
    (@ret, NULL, 'Engineering'),
    (@ret, NULL, 'Weapons Station'),
    #Perseus
    (@seus, NULL, 'Perseus'),
    (@seus, NULL, 'Bridge'),
    (@seus, NULL, 'Gunnery'),
    (@seus, NULL, 'Engineering'),
    (@seus, NULL, 'Weapons Station'),
    #Carrack
    (@carr, NULL, 'Carrack'),
    (@carr, NULL, 'Bridge'),
    (@carr, NULL, 'Gunnery'),
    (@carr, NULL, 'Science & Exploration'),
    (@carr, NULL, 'Engineering'),
    #Reclaimer
    (@claimer, NULL, 'Reclaimer'),
    (@claimer, NULL, 'Bridge'),
    (@claimer, NULL, 'Claw Operator'),
    (@claimer, NULL, 'Salvage Operator'),
    (@claimer, NULL, 'Cargo'),
    #Generic Large
    (@genl, NULL, 'Generic Large'),
    (@genl, NULL, 'Bridge'),
    (@genl, NULL, 'Gunnery'),
    (@genl, NULL, 'Engineering'),
    (@genl, NULL, 'Utility'),
    #Valkyrie
    (@valk, NULL, 'Valkyrie'),
    (@valk, NULL, 'Bridge'),
    (@valk, NULL, 'Gunnery'),
    (@valk, NULL, 'Engineering'),
    (@valk, NULL,'Ground Assault'),
    (@valk, NULL, 'Medical'),
    #600i
    (@600, NULL, '600i'),
    (@600, NULL, 'Bridge'),
    (@600, NULL, 'Scanning/Navigation'),
    (@600, NULL, 'Security'),
    #Generic Medium
    (@genm, NULL, 'Generic Medium'),
    (@genm, NULL, 'Bridge'),
    (@genm, NULL, 'Gunnery'),
    (@genm, NULL, 'Utility'),
    #MSR
    (@msr, NULL, 'Mercury Star Runner'),
    (@msr, NULL, 'Bridge'),
    (@msr, NULL, 'Scanning/Data'),
    (@msr, NULL, 'Gunnery'),
    #Redeemer
    (@redeemer, NULL, 'Redeemer'),
    (@redeemer, NULL, 'Bridge'),
    (@redeemer, NULL, 'Gunnery'),
    #MOLE
    (@mole, NULL, 'MOLE'),
    (@mole, NULL, 'Bridge'),
    (@mole, NULL, 'Mining Operators'),
    (@mole, NULL, 'Utility'),
    #GENERIC SMALL
    (@gens, NULL, 'Generic Small');
