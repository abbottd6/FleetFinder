      ...
      steps {
        script {
          sh """
            ...
            git merge origin/dev_main --no-ff -m "CI: merge dev_main into prod_main for \$newTag"
      ...
      steps {
        script {
          ...
          sh """
            ...
            git checkout prod_main
            git tag -f \$newTag
            git push https://abbottd6:\$GITHUB_TOKEN@github.com/abbottd6/FleetFinder.git refs/tags/\$newTag --force
          """
        }
      }
    }
